...
'reports/member_certificate_report.xml',
...
'views/student_search_templates.xml',

'wizards/close_workshop_wizard_views.xml',
...
'assets': {
        'web.assets_frontend': [
            ...
            'charity_clubs/static/src/js/website_registration_language.js',
            'charity_clubs/static/src/js/student_search.js',
        ],
