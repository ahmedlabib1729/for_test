  ...
  Future<void> _loadMoreAnnouncements() async {
    ...
    try {
      ...
      setState(() {
        ...
        _applyFilters();
        currentOffset = currentOffset + moreAnnouncements.length;        hasMore = moreAnnouncements.length == pageSize;
        isLoadingMore = false;
      });
    } catch (e) {
      setState(() {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      final searchResults = await widget.odooService.searchAnnouncements(
        widget.employee.id,        // ✅ int أولاً
        searchController.text,     // ✅ بدون underscore
